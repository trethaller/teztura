...
(function() {
  var $mainCanvas, FloatBuffer, Layer, Point, changeGamma, createCanvas, drawing, gamma, getMainContext, getPenPressure, height, layer, onDraw, refresh, width;
...
;
  ...
  onDraw = function(e) {
    ...
    return getMainContext().drawImage(layer.canvas, brushRect[0], brushRect[1], brushRect[2], brushRect[3], brushRect[0], brushRect[1], brushRect[2], brushRect[3]);
  };
